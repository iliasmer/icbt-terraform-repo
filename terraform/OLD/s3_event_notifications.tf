...
#     aws_lambda_permission.allow_s3_invoke_treatment_recommendation_lambda
#   ]
# }
...
# resource "aws_lambda_permission" "allow_s3_invoke_treatment_recommendation_lambda" {
#   statement_id  = "AllowS3InvokeTreatmentRecommendationLambda"
#   action        = "lambda:InvokeFunction"
